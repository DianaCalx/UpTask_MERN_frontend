...
const FormularioProyecto = () => {
  ...
  const handleSubmit = async e => {
    ...
    // Pasor los datos del proyecto al provider
  ...
  return (
    <form className='bg-white py-10 px-5 md:w-1/2 rounded-lg shadow' onSubmit={handleSubmit}>
      ...
      <input
        ...
        className='bg-sky-800 w-full p-3 uppercase font-bold text-white  rounded cursor-pointer hover:bg-sky-700 transition-colors'
      />
    </form>
  )
}
